function descargarClientes(){
    return new Promise((resolve,reject)=>{
        const error = true; //con esto controlo si salta el try o catch
        //false, el listado se descargó
        //true error de conexion
        setTimeout(() => {
            if(!error){
...
/*Async await desde un function declaration 
...
//Async await desde un function expression

const ejecutar= async() =>{ //func padre es la que tiene el async
try { 
    console.log(1+1);
